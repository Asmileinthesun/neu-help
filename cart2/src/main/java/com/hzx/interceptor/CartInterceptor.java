...
import static com.hzx.common.constant.CartConstant.TEMP_USER_COOKIE_NAME;
import static com.hzx.common.constant.CartConstant.TEMP_USER_COOKIE_TIMEOUT;
...
public class CartInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //获得当前登录用户的信息
        MemberVo memberResponseVo = (MemberVo) session.getAttribute(AuthServerConstant.LOGIN_USER);
