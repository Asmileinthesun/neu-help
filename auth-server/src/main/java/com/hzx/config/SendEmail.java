...
public class  SendEmail {
    //发件人的邮箱和授权码
    public   String myEmailAccount= "310873984@qq.com";
    public   String myEmailPassword = "cczikdpbaveobjje";//
    ...
    public MimeMessage createMessage(Session session, String sendMail, String receiveMail, String info) throws Exception {
        ...
        message.setContent("尊敬的用户:你好! 注册验证码为"+info, "text/html;charset=UTF-8");
        // 6. 设置发件时间
